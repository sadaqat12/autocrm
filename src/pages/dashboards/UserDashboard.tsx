...
import AutoCRMAgent from '../../components/AutoCRMAgent';
      ...
      {selectedOrg ? (
        ...
        <>
          ...
          <button
            ...
            className="fixed bottom-8 right-8 p-4 bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
